...
// getRevenueStats + its RevenueStats type lived here until slice 2b. Every
// figure but one was invoice-derived and is gone; the survivor (committed
// annual PMA value) moved to lib/data/agreements.ts as
// getCommittedAnnualRevenue, where its data actually lives.
