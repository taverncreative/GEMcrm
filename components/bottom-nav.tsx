 ...
 * capable — + Add Customer link; no invoice entry — invoicing is
 * job-driven from the Jobs list's Completed tab, with the customer side
 * panel as the ad-hoc escape hatch). "More" opens an overflow sheet
 * (Calendar / Documentation / Settings).
 *
...
const MORE_LINKS: { label: string; href: string; icon: React.ReactNode }[] = [
  { label: "Agreements", href: ROUTES.AGREEMENTS, icon: <AgreementsMini /> },
  { label: "Quotes", href: ROUTES.QUOTES, icon: <QuotesMini /> },
  { label: "Calendar", href: ROUTES.CALENDAR, icon: <CalendarMini /> },
  { label: "Documentation", href: ROUTES.REPORTS, icon: <DocsMini /> },
  { label: "Site folders", href: ROUTES.LIBRARY, icon: <LibraryMini /> },
